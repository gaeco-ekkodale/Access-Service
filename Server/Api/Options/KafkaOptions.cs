...
public class KafkaOptions
{
    ...
    /// </summary>
    public required string ConsumerGroup
    {
        get; set;
    }
    ...
    /// </summary>
    [Required]
    public required KafkaTopicsOptions Topics
    {
        get; set;
    }
}
...
{
    /// <summary>
    /// Gets or sets the name of the AccessRights topic.
    /// </summary>
    [Required]
    public required string AccessRights
    {
        get; set;
    }

    /// <summary>
    /// Gets or sets the name of the UserGroup topic.
    /// </summary>
    [Required]
    public required string UserGroups
    {
        get; set;
    }

    /// <summary>
    /// Gets or sets the name of the Guidelines topic to consume guideline upload events from.
    /// </summary>
    [Required]
    public required string Guidelines
    {
        get; set;
    }

    /// <summary>
    /// Gets or sets the name of the UseCaseGuidelines topic to publish UseCase-Guideline upload events to.
    /// </summary>
    [Required]
    public required string UseCaseGuidelines
    {
        get; set;
    }
}
