...
/// <summary>
/// A message to notify that a access right has been updated.
/// </summary>
public class UpdatedAccessRight
{
    /// <summary>
    /// Gets or sets the unique identifier of the updated access right.
    /// </summary>
    public string Id { get; set; } = string.Empty;

    /// <summary>
    /// Gets or sets the updated name of the access right.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets the updated property right.
    /// </summary>
