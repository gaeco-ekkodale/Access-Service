...
public class GetAccessRightsByUseCaseUserGroupAsync_Tests
{
    ...
    public GetAccessRightsByUseCaseUserGroupAsync_Tests()
    {
    ...
    /// <summary>
    /// Test that GetAccessRightsByUseCaseUserGroupAsync returns OK (200) with a list of access rights for the given use case and user group ID.
    /// </summary>
    [Fact]
    public async Task GetAccessRightsByUseCaseUserGroupAsync_ReturnsOk_WithListOfAccessRights()
    {
        // Arrange
        ...
        _accessRightsRepository.GetAccessRightsByUseCaseUserGroupAsync("useCaseId", "userGroupId").Returns(accessRightsDb);
        ...
        // Act
        var result = await _controller.GetAccessRightsByUseCaseUserGroupAsync("useCaseId", "userGroupId");
    ...
    /// <summary>
    /// Test that GetAccessRightsByUseCaseUserGroupAsync returns OK (200) with an empty list when no access rights are found for the given use case and user group ID.
    /// </summary>
    [Fact]
    public async Task GetAccessRightsByUseCaseUserGroupAsync_ReturnsOk_WithEmptyList()
    {
        // Arrange
        _accessRightsRepository.GetAccessRightsByUseCaseUserGroupAsync("useCaseId", "userGroupId").Returns(new List<AccessRight>());
    ...
    /// <summary>
    /// Test that GetAccessRightsByUseCaseUserGroupAsync throws an exception that would be caught by middleware, resulting in a 500 Internal Server Error.
    /// </summary>
    [Fact]
    public async Task GetAccessRightsByUseCaseUserGroupAsync_ReturnsInternalServerError_WhenExceptionIsThrown()
    {
        // Arrange
        _accessRightsRepository.GetAccessRightsByUseCaseUserGroupAsync("useCaseId", "userGroupId")
            .Returns<Task<IEnumerable<AccessRight>>>(x => throw new Exception("Test exception"));

        // Act
        Func<Task> action = async () => await _controller.GetAccessRightsByUseCaseUserGroupAsync("useCaseId", "userGroupId");
